...
class RetrievalAgent:
    ...
    def _to_retrieved_product(self, item: dict, query: QueryUnderstanding) -> RetrievedProduct:
        ...
        return RetrievedProduct(
            ...
            camera_sentiment=metadata.get("camera_sentiment"),
            camera_mentions=metadata.get("camera_mentions"),
            battery_sentiment=metadata.get("battery_sentiment"),
            battery_mentions=metadata.get("battery_mentions"),
            performance_sentiment=metadata.get("performance_sentiment"),
            performance_mentions=metadata.get("performance_mentions"),
            display_sentiment=metadata.get("display_sentiment"),
            display_mentions=metadata.get("display_mentions"),
            value_sentiment=metadata.get("value_sentiment"),
            value_mentions=metadata.get("value_mentions"),
        )